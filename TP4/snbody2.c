// Code SoA avec une unique structure particule et optimisation du pow avec utilisation de 1/sqrt(), avec implémentation de cette dernière. 
  ...
  for (u64 i = 0; i < n; i++)
      ...
      for (u64 j = 0; j < n; j++)
	{
	  //Newton's law
        ...
        const f32 d_3_over_2 = InvSqrt(d_3); //13
